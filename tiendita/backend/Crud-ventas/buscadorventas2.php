...
$buscardor = mysqli_query($con, "select * from ventas where cliente LIKE LOWER('%" . $_POST["buscar2"] . "%') and fecha between '" . $_POST["fecha1"] . "' and '" . $_POST["fecha2"] . "'");
...
<?php while ($resultado = mysqli_fetch_assoc($buscardor)) { ?>
    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-3">
        <div class="col-9 bg-primary redondear py-2 px-2">
            ...
            <a onclick="return confirmacion()" class="btn btn-danger mb-2" href="deletev.php?id=<?php echo $resultado['id'] ?>">
